...
if (isset($_POST['edit_setting'])) {
	...
	$message = '
	<div class="alert alert-success alert-dismissible fade show" role="alert">Dữ liệu đã chỉnh sửa <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>
	';
}
...
<div class="container-fluid px-4">
	...
	<div class="card mb-4">
		<div class="card-header">
			<i class="fas fa-user-edit"></i> Cài đặt Library
		</div>
		<div class="card-body">
			...
			<form method="post">
				...
				?>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="mb-3">
								<label class="form-label">Giới hạn ngày trả sách</label>
						...
						<div class="col-md-6">
							<div class="mb-3">
								<label class="form-label">Tiền trả sách trễ 1 ngày</label>
					...
					<div class="row">
						<div class="col-md-6">
							<label class="form-label">Giới hạn phát hành sách cho mỗi người dùng</label>
					...
					<div class="mt-4 mb-0">
						<input type="submit" name="edit_setting" class="btn btn-primary" value="Lưu" />
					</div>
