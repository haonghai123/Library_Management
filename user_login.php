...
if(isset($_POST["login_button"]))
{
	...
	{
		$message .= '<li>Vui lòng nhập Email</li>';
	}
	else
	{
	...
	{
		$message .= '<li>Vui lòng nhập mật khẩu</li>';
	}	
	else
	{
		...
		if($statement->rowCount() > 0)
		{
			foreach($statement->fetchAll() as $row)
			{
				if($row['user_status'] == 'Enable')
				{
					...
					{
						$message = '<li>Sai mật khẩu</li>';
					}
				}
				else
				{
					$message = '<li>Tài khoản của bạn đã bị vô hiệu hóa</li>';	
				}
			}
		}
		else
		{
			$message = '<li>Sai địa chỉ Email</li>';
		}
	}
}
...
<div class="d-flex align-items-center justify-content-center" style="height:700px;">
	<div class="col-md-6">
		...
		?>
		<div class="card">
			<div class="card-header">Người dùng đăng nhặp</div>
			<div class="card-body">
				<form method="POST">
					<div class="mb-3">
