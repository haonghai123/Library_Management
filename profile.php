	...
	if(!empty($_FILES['user_profile']['name']))
	{
		...
		if(in_array($img_ext, $extensions))
		{
			if($image_size <= 2000000)
			{
				...
				{
					$message .= '<li>Kích thước hình ảnh phải là 225 X 225</li>';
				}
			}
			else
			{
				$message .= '<li>Kích thước hình ảnh 2MB</li>';
			}
		}
		else
		{
			$message .= '<li>Tệp ảnh không hợp lệ</li>';
		}
	}
			...
			?>
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<br />
						<span class="text-muted">Chỉ định dạng .jpg & .png. Kích cỡ ảnh 225 x 225</span>
						<br />
